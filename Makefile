...
testcoverage:
     # Does not work yet
	@+make coverclean
	nosetests unireedsolomon --with-coverage --cover-package=unireedsolomon --cover-erase --cover-min-percentage=80 -d -v
...
prebuildclean:
	...
	@+python -c "import shutil; shutil.rmtree('unireedsolomon.egg-info', True)"
coverclean:
